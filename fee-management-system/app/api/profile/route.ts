...
export async function GET() {
  try {
    ...
    if (!user.profile) {
      ...
      return NextResponse.json<ProfileResponse>(updatedUser as unknown as ProfileResponse)
    }

    return NextResponse.json<ProfileResponse>(user as unknown as ProfileResponse)
  } catch (error) {
