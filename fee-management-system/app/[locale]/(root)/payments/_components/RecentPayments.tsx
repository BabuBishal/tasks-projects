...
import { CardHeader } from "@/components/ui/card/Card";
...
const RecentPayments = () => {
  const { data: paymentsData, isLoading: recentPaymentsLoading } =
    useGetPaymentsQuery({});
  // console.log("🚀 ~ RecentPayments ~ recentPayments:", paymentsData);

  const recentPayments = paymentsData?.payments.slice(0, 5);
  console.log("🚀 ~ RecentPayments ~ recentPayments:", recentPayments);
