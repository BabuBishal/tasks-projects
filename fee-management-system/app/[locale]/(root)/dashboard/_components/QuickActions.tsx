...
const QuickActions = () => {
  ...
  return (
    <div className="border-border flex w-full flex-col gap-4 rounded-lg border p-4">
      <div>
        <h5 className="text-secondary text-md font-semibold">{t('title')}</h5>
        <h6 className="text-muted text-sm font-normal">{t('subtitle')}</h6>{' '}
      </div>
      <div className="flex flex-col gap-5 pb-4">
        ...
        >
          ...
          <span className="text-secondary text-sm">{t('makePayment')}</span>
        </Link>
        <Link
          href="/reports"
          className="border-border hover:bg-accent flex cursor-pointer items-center justify-start gap-2 rounded-md border p-1.5 transition duration-200"
        >
          ...
          <span className="text-secondary text-sm">{t('generateReport')}</span>
        </Link>
        <Link
          href="/students"
          className="border-border hover:bg-accent flex cursor-pointer items-center justify-start gap-2 rounded-md border p-1.5 transition duration-200"
        >
          ...
          <span className="text-secondary text-sm">{t('viewStudents')}</span>
        </Link>
        {/* <Link
