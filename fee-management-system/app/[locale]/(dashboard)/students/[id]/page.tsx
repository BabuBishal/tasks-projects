...
export default function StudentDetailsPage() {
  ...
  const [student, setStudent] = useState<StudentWithComputedTotals | null>(
    null
  );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 ">
          <div className="bg-card rounded-lg shadow p-6">
            <h2 className="text-xl font-bold text-primary mb-4">Fee Records</h2>
            {Array.isArray(student.fees) && student.fees.length === 0 ? (
              ...
              <div className="space-y-5 max-h-[50vh] overflow-y-auto">
                {Array.isArray(student.fees) &&
                  student.fees.map((fee, index, array) => {
